        ...
        <div className="container-profile">
            <header className="topbar">
                <Link to="/" className="nav-logo-link">
                    <img src="/logo-synk.png" alt="Synk Logo" className="nav-logo" />
                </Link>
                ...
                <div className="user-area" ref={menuRef}>
                    ...
                    {menuOpen && (
                        <div className="user-menu" role="menu">
                            <button className="user-menu-item" role="menuitem" onClick={() => { setShowEdit(true); setMenuOpen(false); }}>Editar Perfil</button>
            ...
            {showEdit && (
                <div className="profile-modal" role="dialog" aria-modal="true" aria-label="Editar Perfil">
                    ...
                    <div className="modal-content">
                        ...
                        <h2 className="modal-title">Editar Tu Perfil</h2>
